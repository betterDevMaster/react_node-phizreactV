...
var _socket = new WebSocket("ws://127.0.0.1:8080");
    ...
    rtc.createStream = function (connectionId, opt, onSuccess, onFail) {
        ...
        try{
            ...
            if (media.source === "display"){
                streamPromise = navigator.mediaDevices.getDisplayMedia(rtc.config.displayMediaConstraints);
            }else{
                streamPromise = navigator.mediaDevices.getUserMedia(media);
            }                        
...
(function( $, window, document, undefined ){
    ...
    $.fn.mgVideoChatUI = function(mgVideoChat, rtc, fileHelper){
...
(function( $, window, document, undefined ){
    ...
    var mgVideoChat = function( elem, options ){
        ...
        $.fn.mgVideoChatUI(mgVideoChat, rtc, fileHelper);
        ...
        this.loadTplByName('tplConnections', function(connTpl){
            ...
            self.loadTplByName('tplMain', function(mainTpl){                 
                ...
                if(!rtc.checkCompatibility(errors, warnings, 'chat')){
                    ...
                    errorMessage.push(self._('Make sure you are using up to date browser over HTTPS connection.'));
    ...
    mgVideoChat.prototype.onRoomOptions = function(){
        var self = this;
        //share desktop
        this.roomOptions.desktopShare =  this.roomOptions.desktopShare && navigator.mediaDevices.getDisplayMedia;
        //group chat
